...
public class Chapter02 {
        ...
        throws InterruptedException
    {
        ...
        updateToken(conn, token, "hongxf", "itemX");
        System.out.println("We just logged-in/updated token: " + token);
        System.out.println("For user: 'hongxf'");
        System.out.println();
...
//        };
        ...
        extends Thread
    {
        ...
        public CleanSessionsThread(int limit) {
            this.conn = new Jedis("192.168.11.81");
            this.conn.select(0);
            this.limit = limit;
        }
        ...
        public void run() {
            while (!quit) {
                ...
                List<String> tokenSet = conn.lrange("recent:", 0, endIndex - 1);
        ...
        extends Thread
    {
        ...
        public void run() {
            while (!quit) {
                ...
                List<String> sessionSet = conn.lrange("recent:", 0, endIndex - 1);
